...
popup_icons <- awesomeIconList(
  ...
  "101-1000" = makeAwesomeIcon(icon = "stats", library = "glyphicon", markerColor = "orange"),
  "1001-10000" = makeAwesomeIcon(icon = "stats", library = "glyphicon", markerColor = "red"),
  "10001-100000" = makeAwesomeIcon(icon = "stats", library = "glyphicon", markerColor = "black"),
  "100000-" = makeAwesomeIcon(icon = "stats", library = "glyphicon", markerColor = "black", iconColor = "darkred")
)
...
data[, `:=`(
  ...
  icon_group = cut(
    data$Confirmed,
    breaks = c(-1, 0, 100, 1000, 10000, 100000, 100000000),
    labels = c("0", "1-100", "101-1000", "1001-10000", "10001-100000", "100000-")
  ),
  label = paste0(
    CountryName,
    " <br> ", RegionName,
